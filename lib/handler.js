...
var secret  = "change_this_to_something_randomized";
...
exports.submitNewBlogPost = function submitNewBlogPost(req, res) {
    ...
    req.on("data", function(data) {
        ...
        var thisMonth = months[req.post.date.getMonth()];
...
exports.logMeIn = function logMeIn(req, res) {
    if (req.method === "POST") {
        ...
        req.on("data", function(data) {
            ...
            model.checkUserInDB(post, req, res, authSuccess, exports.loginPage);
        });
    } else {
...
function authSuccess(req, res) {
    ...
    model.writeTokenToDB(GUID, record, function() {
        ...
        var fn = jade.compileFile(root + "/lib/views/loginsuccess.jade");
